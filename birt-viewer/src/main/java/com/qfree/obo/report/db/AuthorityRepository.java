...
public interface AuthorityRepository extends JpaRepository<Authority, UUID> {
	 ...
	 * {@link Authority} entities that have been granted <b>directly</b> to the
	 * {@link Role} with a specified value of roleId.
	 * 
	 * @param roleId
	 ...
	 * (these duplicates occur because [role_authority] junction records
	 * may link both a [role] as well as one or more of its ancestor [role] records to
	 * the same [authority]), the SELECT list must include the column that
	 * we order on, in this case authority.name. But I only want to 
	 * return a list of authority_id's; hence, I perform a select on the
	 * derived table (that takes care of the DISTINCT business for us)
	 * to create the derived table, and then I can order by DT.name 
