 ...
 */
@XmlTransient
public abstract class AbstractCollectionResourceXXXXXX<T extends AbstractBaseResource, U> extends AbstractBaseResource {

	private static final Logger logger = LoggerFactory.getLogger(AbstractCollectionResourceXXXXXX.class);
	...
	public AbstractCollectionResourceXXXXXX() {
	}
	...
	//	 * @param queryParams
	//	 */
	//	protected void init(List<U> entities,
	//			Class<U> entityClass,
	//			String baseResourceUri,
	//			String collectionPath,
	//			UriInfo uriInfo,
